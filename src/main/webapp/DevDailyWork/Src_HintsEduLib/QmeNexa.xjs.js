    ...
    return function(path)
    {
        ...
        */
        ...
        pForm.gfn_getAllInitData = function()
        {
        	...
        	var sQMELOGONUSERID = 	nexacro.getApplication().LogonUserId;		this.gtrace(" - 유저 : sQMELOGONUSERID--->"+sQMELOGONUSERID,gtrcPos);
        				...
        				switch(sTmpCmType)		//	dsName, cmType
        				{
        					...
        					default :
        						...
        						this.addChild(tCommInDsName, tCommInDs);
        							...
        							sArguments	+=	"getCodeInfo"		+" ";	//	this.gtrace(" - sArguments-->"+sArguments, gtrcPos);
        							sInDatasets	+=	"ds_in"+iSeq+"="+tCommInDsName	+" ";
        							sOutDatasets+=	sTmpDsName+"=ds_out"+iSeq		+" ";
        							iSeq++;
        						break;
        ...
        */
        ...
        pForm.gfn_getParentForm = function(){
        	...
        	if(this.oDivParnt.hasOwnProperty("targetGrid")){
        		if(!this.gfn_isNull(this.oDivParnt.parent.lookup(this.oDivParnt.targetGrid)))
        		{
        			//	this.oTargetGrid 		= this.oFrmParnt.lookup(this.oDivParnt.targetGrid);
        			this.oTargetGrid 		= this.oDivParnt.parent.lookup(this.oDivParnt.targetGrid);
