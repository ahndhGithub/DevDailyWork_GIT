(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_updatecontrol("true");
            obj.set_useclientlayout("false");
            obj._setContents("<ColumnInfo><Column id=\"code\" size=\"256\" type=\"STRING\"/><Column id=\"value\" size=\"256\" type=\"STRING\"/></ColumnInfo><Rows><Row><Col id=\"code\">1</Col><Col id=\"value\">폴더</Col></Row><Row><Col id=\"code\">2</Col><Col id=\"value\">슬라이드</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("grd_sample","10","50","582","294",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_binddataset("ds_sample");
            obj.getSetter("useinputpanel").set("false");
            obj.set_cellsizingtype("col");
            obj.set_cellmovingtype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell colspan=\"4\" text=\"Merge1\"/><Cell col=\"4\" rowspan=\"2\" text=\"col5\"/><Cell col=\"5\" colspan=\"2\" text=\"Merge2\"/><Cell row=\"1\" text=\"col1\"/><Cell row=\"1\" col=\"1\" text=\"col2\"/><Cell row=\"1\" col=\"2\" text=\"col3\"/><Cell row=\"1\" col=\"3\" text=\"col4\"/><Cell row=\"1\" col=\"5\" text=\"col6\"/><Cell row=\"1\" col=\"6\" text=\"col7\"/></Band><Band id=\"body\"><Cell text=\"bind:col1\"/><Cell col=\"1\" displaytype=\"combo\" text=\"bind:col2\" combodataset=\"ds_type\" combocodecol=\"code\" combodatacol=\"value\"/><Cell col=\"2\" text=\"bind:col3\"/><Cell col=\"3\" text=\"bind:col4\"/><Cell col=\"4\" displaytype=\"date\" text=\"bind:col5\"/><Cell col=\"5\" displaytype=\"number\" style=\"align:right;\" text=\"bind:col6\"/><Cell col=\"6\" displaytype=\"normal\" style=\"align:right;\" text=\"bind:col7\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Grid("grd_sample2","10","386","582","294",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Button("btn_filter","518","362","72","20",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("필터사용");
            this.addChild(obj.name, obj);

            obj = new Static("Static00","13","31","561","12",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("Grid Head Cell 에 마우스를 올리면 필터버튼이 생성됨 (merge cell 제외)");
            this.addChild(obj.name, obj);

            obj = new Button("Button00","657","95","339","175",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("NEXACRO 17");
            this.addChild(obj.name, obj);

            obj = new Div("Div00","621","330","256","285",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("Div00");
            obj.set_url("GridFilter::GridFilterPop.xfdl");
            this.addChild(obj.name, obj);

            obj = new PopupDiv("PopupDiv00","640","515","332","190",null,null,null,null,null,null,this);
            obj.set_text("PopupDiv00");
            obj.set_visible("true");
            obj.set_url("GridFilter::GridFilterPop.xfdl");
            this.addChild(obj.name, obj);

            obj = new Button("Button01","515","126","410","36",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("Button01");
            this.addChild(obj.name, obj);

            obj = new Button("Button01_00","505","182","410","36",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("Button01");
            this.addChild(obj.name, obj);
        ...
        {
            this._addPreloadList("fdl","GridFilter::GridFilterPop.xfdl");
            this._addPreloadList("data","","ds_sample2");
            this._addPreloadList("data","","ds_type");
        ...
        ******************************************************************************/
        ...
        {
        	//	this.ds_sample.filter("col1=='A'");
        	this.ds_sample.filter("(col1=='A44444444')");
        	//	(USAGE=="aaa")
        };

        this.Button01_00_onclick = function(obj,e)
        {
        	this.ds_sample.filter("");
        };
