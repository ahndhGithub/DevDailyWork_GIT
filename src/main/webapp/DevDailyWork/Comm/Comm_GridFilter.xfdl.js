(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("Comm_GridFilter.xfdl","Src_HintsEduLib::All_EduLib.xjs");
        ...
        */
        ...
        {																var gtrcPos	=	"Comm_GridFilter.xfdl.btn_filter_onclick";
        	var dataset = this.fv_targetDataset;						this.gtrace("dataset.name--->"+dataset.name, gtrcPos);
            var filterstr = "";
