(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("richtexteditor_colorpicker.xfdl","Library_RichTextEditor::lib_base.xjs");
        this.addIncludeScript("richtexteditor_colorpicker.xfdl","Library_RichTextEditor::lib_color.xjs");
