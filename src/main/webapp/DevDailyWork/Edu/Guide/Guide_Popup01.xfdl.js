(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta_00","114","299",null,"29","20",null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_cssclass("sta_WF_detailLine");
            this.addChild(obj.name, obj);

            obj = new Div("div_search","20","52","470","39",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Combo("cmb_dept","69","8","140","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("0");
            ...
            obj = new Static("Static01","0","8","69","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("1");
            obj.set_text("부서");
            obj.getSetter("leftbase").set("");
            obj.getSetter("topbase").set("");
            ...
            obj = new Static("Static00","209","8","72","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("2");
            obj.set_text("성명");
            obj.getSetter("leftbase").set("");
            obj.getSetter("topbase").set("");
            ...
            obj = new Edit("edt_name","281","8","140","20",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("3");
            this.div_search.addChild(obj.name, obj);
            ...
            obj = new Static("Static05","20","96","97","30",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("조회결과");
            obj.set_cssclass("sta_WF_title");
            this.addChild(obj.name, obj);

            obj = new Grid("grd_list","20","126",null,"138","20",null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_binddataset("ds_emp");
            obj.set_scrolltype("none");
            obj.set_autofittype("col");
            obj.set_autosizebandtype("head");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"88\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"26\"/></Rows><Band id=\"head\"><Cell text=\"법인\"/><Cell col=\"1\" text=\"부서\"/><Cell col=\"2\" text=\"성명\"/><Cell col=\"3\" text=\"사원번호\"/></Band><Band id=\"body\"><Cell text=\"bind:CORP_CODE\" displaytype=\"combotext\" edittype=\"combo\" combodataset=\"ds_corp\" combocodecol=\"CORP_CODE\" combodatacol=\"CORP_NAME\"/><Cell col=\"1\" text=\"bind:DEPT_CODE\"/><Cell col=\"2\" text=\"bind:FULL_NAME\"/><Cell col=\"3\" text=\"bind:EMPL_ID\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Static("Static04","10","91",null,"5","20",null,null,null,null,null,this);
            obj.set_taborder("7");
            ...
            obj = new Static("Static06","20","22","97","30",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("조회조건");
            obj.set_cssclass("sta_WF_title");
            this.addChild(obj.name, obj);

            obj = new Static("Static12","20","269","97","30",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("상세정보");
            obj.set_cssclass("sta_WF_title_sub");
            this.addChild(obj.name, obj);

            obj = new Static("Static07","20","299","95","29",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("법인");
            obj.set_cssclass("sta_WF_detailLabel");
            this.addChild(obj.name, obj);

            obj = new Static("Static10","20","327","95","29",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("성명");
            obj.set_cssclass("sta_WF_detailLabel");
            this.addChild(obj.name, obj);

            obj = new Static("sta_01","114","327",null,"29","20",null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_cssclass("sta_WF_detailLine");
            this.addChild(obj.name, obj);

            obj = new Static("Static13","20","355","95","29",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_text("성별");
            obj.set_cssclass("sta_WF_detailLabel");
            this.addChild(obj.name, obj);

            obj = new Static("sta_02","114","355",null,"29","20",null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_cssclass("sta_WF_detailLine");
            this.addChild(obj.name, obj);

            obj = new Static("Static15","10","264",null,"5","20",null,null,null,null,null,this);
            obj.set_taborder("19");
            obj.set_cssclass("sta_WF_guideBlue");
            obj.set_visible("false");
            obj.set_text("h5");
            ...
            obj = new Static("Static09","256","299","95","29",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("부서");
            obj.set_cssclass("sta_WF_detailLabel");
            this.addChild(obj.name, obj);

            obj = new Static("Static11","256","327","95","29",null,null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_text("사원번호");
            obj.set_cssclass("sta_WF_detailLabel");
            this.addChild(obj.name, obj);

            obj = new Static("Static14","256","355","95","29",null,null,null,null,null,null,this);
            obj.set_taborder("18");
            obj.set_text("전화번호");
            obj.set_cssclass("sta_WF_detailLabel");
            this.addChild(obj.name, obj);

            obj = new Static("Static16","15","384",null,"20","15",null,null,null,null,null,this);
            obj.set_taborder("20");
            obj.set_cssclass("sta_WF_guideBlue");
            obj.set_visible("false");
            obj.set_text("h5");
            ...
            obj = new Button("btn_17","258","403","60","28",null,null,null,null,null,null,this);
            obj.set_taborder("21");
            obj.set_text("취소");
            obj.set_cssclass("btn_WF_pop2");
            this.addChild(obj.name, obj);

            obj = new Button("btn_16","192","403","60","28",null,null,null,null,null,null,this);
            obj.set_taborder("22");
            obj.set_text("확인");
        ...
        // User Script
        this.registerScript("Guide_Popup01.xfdl", function() {
        ...
        this.loadIncludeScript("Guide_Popup01.xfdl");
