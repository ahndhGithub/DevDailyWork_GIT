(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static03","0","74",null,"10","0",null,null,null,null,null,this);
            obj.set_taborder("3");
            ...
            obj = new Combo("cmb_corp","87","8","150","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("1");
            ...
            obj = new Combo("cmb_dept","321","8","150","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("2");
            ...
            obj = new Static("Static01","237","8","61","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("3");
            obj.set_text("부서");
            obj.getSetter("leftbase").set("");
            obj.getSetter("topbase").set("");
            ...
            obj = new Static("Static00","471","8","61","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("4");
            obj.set_text("성명");
            obj.getSetter("leftbase").set("");
            obj.getSetter("topbase").set("");
            ...
            obj = new Edit("edt_name","532","9","150","20",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("5");
            this.div_search.addChild(obj.name, obj);

            obj = new Static("Static02","237","33","85","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("6");
            obj.set_text("입사일자");
            obj.getSetter("leftbase").set("");
            obj.getSetter("topbase").set("");
            ...
            obj = new Static("Static05","0","33","85","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("7");
            obj.set_text("사원번호");
            obj.getSetter("leftbase").set("");
            obj.getSetter("topbase").set("");
            ...
            obj = new Calendar("Calendar00","322","33","150","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("8");
            this.div_search.addChild(obj.name, obj);

            obj = new Edit("Edit00","87","33","129","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("9");
            this.div_search.addChild(obj.name, obj);

            obj = new Button("btn_28","216","33","21","21",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("10");
            obj.set_cssclass("btn_WF_search");
            this.div_search.addChild(obj.name, obj);

            obj = new Button("btn_27","740","6","45","24",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("11");
            obj.set_text("조회");
            obj.set_cssclass("btn_WF_sub1");
            this.div_search.addChild(obj.name, obj);

            obj = new Static("Static02","103","40","649","4",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_cssclass("sta_WF_guideRed");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Tab("Tab00","10","85","796","434",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_tabindex("0");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("grd_list","0","0",null,"406","1",null,null,null,null,null,this.Tab00.Tabpage1.form);
            obj.set_taborder("0");
            obj.set_binddataset("ds_corp");
            obj.set_scrolltype("none");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"30\"/><Column size=\"120\"/><Column size=\"120\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"26\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"0\"/><Cell col=\"1\" text=\"법인코드\"/><Cell col=\"2\" text=\"법인명\"/></Band><Band id=\"body\"><Cell text=\"0\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"bind:CORP_CODE\" combodataset=\"ds_corp\" combocodecol=\"CORP_CODE\" combodatacol=\"CORP_NAME\" textAlign=\"center\"/><Cell col=\"2\" text=\"bind:CORP_NAME\" textAlign=\"center\"/></Band></Format></Formats>");
            ...
            obj = new Grid("grd_list","0","0",null,"406","1",null,null,null,null,null,this.Tab00.Tabpage2.form);
            obj.set_taborder("0");
        ...
        // User Script
        this.registerScript("Guide_Form07.xfdl", function() {
        ...
        this.loadIncludeScript("Guide_Form07.xfdl");
