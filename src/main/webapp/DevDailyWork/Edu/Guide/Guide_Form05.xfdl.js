(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("Master Detail2");
            ...
            obj = new Grid("grd_list00","10","290","97.30%","229",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_binddataset("ds_emp_copy");
            obj.set_scrolltype("none");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"116\"/><Column size=\"108\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"115\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"26\"/></Rows><Band id=\"head\"><Cell text=\"CORP_CODE\"/><Cell col=\"1\" text=\"DEPT_CODE\"/><Cell col=\"2\" text=\"FULL_NAME\"/><Cell col=\"3\" text=\"EMPL_ID\"/><Cell col=\"4\" text=\"HIRE_DATE\"/><Cell col=\"5\" text=\"SALARY\"/><Cell col=\"6\" text=\"BONUS\"/><Cell col=\"7\" text=\"GENDER\"/><Cell col=\"8\" text=\"PHONE_NO\"/><Cell col=\"9\" text=\"E_MAIL\"/><Cell col=\"10\" text=\"BIRTH_DAY\"/><Cell col=\"11\" text=\"MARRIED\"/><Cell col=\"12\" text=\"WEDD_DAY\"/><Cell col=\"13\" text=\"IMG_URL\"/></Band><Band id=\"body\"><Cell text=\"bind:CORP_CODE\" textAlign=\"center\"/><Cell col=\"1\" text=\"bind:DEPT_CODE\" textAlign=\"center\"/><Cell col=\"2\" text=\"bind:FULL_NAME\" textAlign=\"center\"/><Cell col=\"3\" text=\"bind:EMPL_ID\" textAlign=\"center\"/><Cell col=\"4\" text=\"bind:HIRE_DATE\"/><Cell col=\"5\" text=\"bind:SALARY\"/><Cell col=\"6\" text=\"bind:BONUS\"/><Cell col=\"7\" text=\"expr:GENDER == &quot;M&quot; ? &quot;남자&quot; : &quot;여자&quot;\" textAlign=\"center\"/><Cell col=\"8\" text=\"bind:PHONE_NO\"/><Cell col=\"9\" text=\"bind:E_MAIL\"/><Cell col=\"10\" text=\"bind:BIRTH_DAY\"/><Cell col=\"11\" text=\"bind:MARRIED\"/><Cell col=\"12\" text=\"bind:WEDD_DAY\"/><Cell col=\"13\" text=\"bind:IMG_URL\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("Guide_Form05.xfdl","EduLibXjs::Frame.xjs");
        this.addIncludeScript("Guide_Form05.xfdl","EduLibXjs::Grid.xjs");
        this.addIncludeScript("Guide_Form05.xfdl","EduLibXjs::Util.xjs");
        this.registerScript("Guide_Form05.xfdl", function() {
        // include "EduLibXjs::Comp.xjs";
        // include "EduLibXjs::Excel.xjs";
        this.executeIncludeScript("EduLibXjs::Frame.xjs"); /*include "EduLibXjs::Frame.xjs"*/;
        this.executeIncludeScript("EduLibXjs::Grid.xjs"); /*include "EduLibXjs::Grid.xjs"*/;
        // include "EduLibXjs::Message.xjs";
        // include "EduLibXjs::Popup.xjs";
        // include "EduLibXjs::Transaction.xjs";
        this.executeIncludeScript("EduLibXjs::Util.xjs"); /*include "EduLibXjs::Util.xjs"*/;
        // include "EduLibXjs::Validation.xjs";
        ...
        {
        	this.ds_emp_copy.addRow();
        };

        this.btn_00_onclick = function(obj,e)
        {
        	this.ds_emp_copy.deleteRow(this.ds_emp_copy.rowposition);
        };
        ...
        this.loadIncludeScript("Guide_Form05.xfdl");
