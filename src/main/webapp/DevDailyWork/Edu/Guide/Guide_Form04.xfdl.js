(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("Master Detail1");
            ...
            obj = new Grid("grd_list","10","40","47%","479",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Grid("grd_list00","grd_list:30","40","46.93%","479",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_binddataset("ds_emp_copy");
            obj.set_scrolltype("none");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"100\"/><Column size=\"120\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"26\"/></Rows><Band id=\"head\"><Cell text=\"법인\"/><Cell col=\"1\" text=\"부서\"/><Cell col=\"2\" text=\"성명\"/><Cell col=\"3\" text=\"사원번호\"/><Cell col=\"4\" text=\"입사일자\"/></Band><Band id=\"body\"><Cell text=\"bind:CORP_CODE\" combodataset=\"ds_corp\" combocodecol=\"CORP_CODE\" combodatacol=\"CORP_NAME\" displaytype=\"combotext\" textAlign=\"center\"/><Cell col=\"1\" text=\"bind:DEPT_CODE\" textAlign=\"center\"/><Cell col=\"2\" text=\"bind:FULL_NAME\" edittype=\"text\" textAlign=\"center\"/><Cell col=\"3\" text=\"bind:EMPL_ID\" edittype=\"mask\" maskeditformat=\"AA-###\" maskedittype=\"string\" textAlign=\"center\"/><Cell col=\"4\" text=\"bind:HIRE_DATE\" displaytype=\"date\" edittype=\"date\" calendarpopupsize=\"156 179\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta_04","763","-361","39","64",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_color("red");
            obj.set_text("h64");
            ...
            obj = new Static("sta_08","468","-345","29","12",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_color("red");
            obj.set_text("h4");
            obj.set_visible("true");
            ...
            obj = new Static("Static20","103","-331","649","4",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_cssclass("sta_WF_guideRed");
            obj.set_visible("true");
            this.addChild(obj.name, obj);

            obj = new Button("btn_01","674","15","62","21",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("행추가");
            this.addChild(obj.name, obj);

            obj = new Button("btn_00","741","15","62","21",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("행삭제");
            this.addChild(obj.name, obj);

            obj = new Static("Static03","11","10","109","30",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("Grid Master");
            obj.set_cssclass("sta_WF_title");
            this.addChild(obj.name, obj);

            obj = new Button("btn_02","264","15","62","21",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("행추가");
            this.addChild(obj.name, obj);

            obj = new Button("btn_03","331","15","62","21",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("행삭제");
            this.addChild(obj.name, obj);

            obj = new Static("Static02","422","10","90","30",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("Grid Detail");
            obj.set_cssclass("sta_WF_title");
            this.addChild(obj.name, obj);

            obj = new Static("Static07","0","0",null,"10","0",null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_cssclass("sta_WF_guideBlue");
            obj.set_visible("false");
            obj.set_text("h10");
        ...
        // User Script
        this.registerScript("Guide_Form04.xfdl", function() {
        ...
        this.on_initEvent = function()
        {
            ...
            this.btn_02.addEventHandler("onclick",this.btn_01_onclick,this);
            this.btn_03.addEventHandler("onclick",this.btn_00_onclick,this);
        ...
        this.loadIncludeScript("Guide_Form04.xfdl");
