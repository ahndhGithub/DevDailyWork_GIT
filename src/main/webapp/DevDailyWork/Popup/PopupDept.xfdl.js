(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("PopupDept.xfdl","Src_HintsEduLib::All_EduLib.xjs");
        this.registerScript("PopupDept.xfdl", function() {
        ...
        this.Form_onload = function(obj,e)
        {
            ...
            this.paramStr = this.getOwnerFrame().pStr;			this.gtrace("paramStr--->"+paramStr, gtrcPos);
            this.paramNum = this.getOwnerFrame().pNum;			this.gtrace("paramNum--->"+paramNum, gtrcPos);
        ...
        this.loadIncludeScript("PopupDept.xfdl");
